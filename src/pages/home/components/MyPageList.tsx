...
const Item = ({ value, toggle, isToggle, id }: ItemProps) => {
  return (
    <div className="px-5 py-[5px] bg-bgColor flex w-[220px] bgPc:w-[260px] justify-between relative ">
      {isToggle === id && (
      ...
      <div className="flex gap-[11px] w-full">
        ...
        <div className="flex flex-col">
          <p className="text-strongPurple text-[15px] leading-[18px]">
            Business name
          </p>
...
const MyPageList = () => {
  ...
  return (
    <div className="w-full bg-white pb-[33px] rounded-b-2xl">
      <div className="min-h-[236px] w-full flex flex-col gap-[6px]  ">
        {items.map((item, idx) => (
          <Item
            key={idx}
            value={item}
